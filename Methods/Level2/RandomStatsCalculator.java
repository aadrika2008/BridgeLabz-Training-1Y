...
public class RandomStatsCalculator {public static int[] generate4DigitRandomNumbers(int size) {
    ...
    // Method to calculate average, minimum, and maximum
    ...
    public static void main(String[] args) {
        int size = 5;
        int[] randomNumbers = generate4DigitRandomNumbers(size);
